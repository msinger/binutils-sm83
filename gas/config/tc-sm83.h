...
#ifndef OBJ_COFF
#define TARGET_FORMAT "elf32-sm83"
#endif
...
/* We allow single quotes to delimit character constants as
   well, but it is cleaner to handle that in tc-sm83.c.  */
#define SINGLE_QUOTE_STRINGS

#define LABELS_WITHOUT_COLONS (sm83_tc_labels_without_colon())
extern int sm83_tc_labels_without_colon (void);
...
#define TC_LABEL_IS_LOCAL sm83_tc_label_is_local
extern int sm83_tc_label_is_local (const char *name);

#define elf_tc_final_processing sm83_elf_final_processing
extern void sm83_elf_final_processing (void);
...
/* SM83 instructions are 1, 2 or 3 bytes long.  */
#define DWARF2_LINE_MIN_INSN_LENGTH	1

/* 16 bit addresses are used on SM83.  */
#define DWARF2_ADDR_SIZE(bfd)		2

/* CFI hooks.  */
#define tc_cfi_frame_initial_instructions sm83_tc_frame_initial_instructions
extern void sm83_tc_frame_initial_instructions (void);

#define tc_regname_to_dw2regnum sm83_tc_regname_to_dw2regnum
extern int sm83_tc_regname_to_dw2regnum (const char *regname);
